...
//  DatingApp
//
//  Created by Radley Hoang on 01/02/2022.
//
...
struct SwipeActionButton: View, Identifiable {
    ...
    var body: some View {
        ZStack {
            ...
            .frame(width: SwipeActionButton.width, height: 50)
        }
    }
}

// MARK: - SwipeActionViewModifier
...
extension View {
    func swipeActions(leading: [SwipeActionButton] = [],
                      allowsFullSwipeLeading: Bool = true,
                      trailing: [SwipeActionButton] = [],
                      allowsFullSwipeTrailing: Bool = true) -> some View {
