                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    ZStack(alignment: .centerTextAlignment) {
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            HStack(spacing: 4) {
                                Group {
                                    if viewModel.isShowOldPassword {
                                        TextField("Nhập mật khẩu cũ", text: $viewModel.oldPassword)
                                        
                                    } else {
                                        SecureField("Nhập mật khẩu cũ", text: $viewModel.oldPassword)
                                    }
                                }
                        ...
                        Image(viewModel.isShowOldPassword ? Asset.Authentication.Signup.icHideEye.name : Asset.Authentication.Signup.icUnhideEye.name)
                            ...
                            .onTapGesture {
                                viewModel.isShowOldPassword.toggle()
                            }
                    }
                    .padding(.bottom, 20)
                            ...
                            HStack(spacing: 4) {
                                Group {
                                    if viewModel.isShowPassword {
                                        TextField("Nhập mật khẩu mới", text: $viewModel.password)
                                        
                                    } else {
                                        SecureField("Nhập mật khẩu mới", text: $viewModel.password)
                                    }
                                }
                                .style(font: .lexendRegular, size: 14, color: Asset.Colors.Global.black100.color)
                                .frame(height: 20)
                            ...
                            HStack(spacing: 4) {
                                Group {
                                    if viewModel.isShowConfirmPassword {
                                        TextField("Nhập lại mật khẩu mới", text: $viewModel.confirmPassword)
                                        
                                    } else {
                                        SecureField("Nhập lại mật khẩu mới", text: $viewModel.confirmPassword)
                                    }
                                }
                                .style(font: .lexendRegular, size: 14, color: Asset.Colors.Global.black100.color)
                                .frame(height: 20)
